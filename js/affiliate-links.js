...
window.addEventListener("load", function () {
  ...
  a.id = "tg-cta";
  a.href = "https://t.me/nis2nastrojesk";
  a.target = "_blank";
  a.rel = "noopener";
  a.textContent = "📣 NIS2 novinky na Telegrame";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!document.getElementById("aff-disclosure")) {
    ...
    d.id = "aff-disclosure";
    d.textContent = "Informácia: táto stránka obsahuje affiliate odkazy. Ak cez ne nakúpite, môžeme získať províziu bez akýchkoľvek nákladov navyše pre vás.";
